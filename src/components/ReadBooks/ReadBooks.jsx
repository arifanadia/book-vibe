...
const ReadBooks = ({ Read }) => {
    ...
    const { tags, bookName, author, category, ratings, image, totalPages, publisher } = Read || {}
    return (
        <div className="flex gap-8 mt-12 border border-[#13131326] rounded-xl p-6 ">
            ...
            <div >
                ...
                <div className="flex mt-6">
                    ...
                    <p className="flex items-center text-[#131313CC] gap-2"><GoLocation /> Year of Publishing: {publisher}</p>
                </div>
