...
const ReadBooks = ({ Read }) => {
    ...
    const { tags, bookName, author, category, ratings, image, totalPages, publisher,bookId,yearOfPublishing } = Read || {}
    return (
        <div className="md:flex gap-8 mt-12 border border-[#13131326] rounded-xl p-6 ">
            ...
            <div >
                ...
                <div className="md:flex mt-6">
                    ...
                    <p className="flex items-center text-[#131313CC] gap-2"><GoLocation /> Year of Publishing: {yearOfPublishing}</p>
                </div>
                ...
                <Link to={`/books-details/${bookId}`} className="mr-6 text-white px-6 py-2 rounded-2xl bg-primary ">View Details </Link>
            </div>
